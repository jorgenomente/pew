...
export function EvolutionChart() {
  ...
  const data: MonthData[] = [
    ...
    { mes: 'Ago', ingresos: 410000, gastos: 220000, balance: 190000 },
    { mes: 'Sep', ingresos: 420000, gastos: 215000, balance: 205000 },
    { mes: 'Oct', ingresos: 430000, gastos: 228000, balance: 202000 },
    { mes: 'Nov', ingresos: 440000, gastos: 205000, balance: 235000 },
  ];
  
  const maxValue = Math.max(...data.flatMap(d => [d.ingresos, d.gastos]));
  ...
  return (
    ...
    >
      ...
      {/* Chart - equal padding on all sides */}
      ...
      <div className="pt-4 border-t border-white/20">
        ...
        <div className="flex items-center justify-between">
          <span className="text-sm opacity-60" style={{ color: '#597370' }}>Promedio combinado</span>
